...
let jsGalleryItem = jsGallery.querySelectorAll(".js-gallery-item")
*/
/*
...
*/
/*
jsGalleryItem.length
let slideCount = jsGalleryItem
let slideWidth = jsGalleryItem[0].offsetWidth
*/
...
jsGalleryItem.length
let slideCount = jsGalleryItem.length
let slideWidth = jsGalleryItem[0].offsetWidth

function transitionSlide () {
  if (currentSlide < slideCount) {
  
  delta = (slideWidth * currentSlide) * -1;
  string = "translateX(" + delta + "px)";
  jsGallery.style.transform = string;
  currentSlide++;
} else {
  delta = 0
  jsGallery.style.tranform = "translateX(0)"; 
  currentSlide = 1;
}
}
let currentSlide = 1
